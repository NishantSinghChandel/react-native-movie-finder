...
export default class App extends Component{
  ...
  fetchMoviesData() {
    // https://api.themoviedb.org/3/discover/movie?callback=JSONP_CALLBACK&sort_by=popularity.desc&api_key=' + this.apiKey
    var url = 'http://api.themoviedb.org/3/movie/now_playing?api_key=eba6955a2c5a4dace95fa4773c9bf2bc';
    fetch(url)
